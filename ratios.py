...
if __name__ == "__main__":
    ...
    sh_rp.sort_values('method', inplace=True)
    ...
    # sns.lineplot(sh_rp, x='k', y='cost', hue='method', errorbar='ci', ax=axs[0])
    ...
    # sns.lineplot(la_rp, x='k', y='cost', hue='method', errorbar='ci', ax=axs[1])
