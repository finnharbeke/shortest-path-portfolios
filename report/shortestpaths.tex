...
Hence, we study the $(s,t)$-pairs in \cref{shanghai} in order to better grasp the structure of their graphs and cost distributions.
...
\caption{The expected distance against the standard deviation of $d_{s,t}$ over all $(s, t)$ pairs in \cref{shanghai}. Each point corresponding to an $(s,t)$ pair is two-coloured matching the colouring in \cref{fig:shanghai} in order to more easily find the corresponding pairs there. For a larger, interactive plot visit \href{https://finnharbeke.github.io/shortest-path-portfolios/sh_dist_scatter.html}{this project’s GitHub Pages}.}
